class Policy {
    ...
    public Policy(int policyNumber, String providerName, String insuredFirstName, String insuredLastName,
            int insuredAge, String insuredSmokingStatus, int insuredHeightInch, int insuredWeightPound) {
    ...
    //getters for each field - No setters -> object fields are initialized through the constructor 
