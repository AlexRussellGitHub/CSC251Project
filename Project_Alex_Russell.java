...
public class Project_Alex_Russell{
    public static void main(String[] args) {
        ...
        Policy policy = new Policy(policyNumber, providerName, insuredFirstName, insuredLastName, insuredAge, insuredSmokingStatus, insuredHeightInch, insuredWeightPound);
